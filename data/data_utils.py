...
def load_data(ticker, folder="data/ohlcv"):
    """
...
def load_and_preprocess_spy(data_folder="data/ohlcv"):
...
def preprocess_data(df):
    ...
    df = df.between_time('09:44', '15:45')
...
def load_data_for_tickers(tickers, date_range, data_folder="data/ohlcv"):
    """
